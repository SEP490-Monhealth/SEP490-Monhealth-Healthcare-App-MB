  ...
  return (
    <>
            ...
            <VStack gap={12}>
              ...
              <VStack>
                ...
                <Text className="text-justify font-tregular text-base text-secondary">
                  ...
                  <Text className="font-tbold">
                    người dùng hoàn thành lịch hẹn (Hiện tại: 200.000₫/lịch
                    hẹn).
                  </Text>{" "}
              ...
              <VStack>
                ...
                <Text className="text-justify font-tregular text-base text-secondary">
                  ...
                  nhận và tiến hành thanh toán. Việc không cung cấp bằng chứng
                  có thể dẫn đến việc{" "}
                  <Text className="font-tbold">
              ...
              <VStack>
                ...
                <Text className="text-justify font-tregular text-base text-secondary">
                  ...
                  <Text className="font-tbold">
                    yêu cầu ngoại lệ lịch trình
                  </Text>{" "}
                  để hệ thống duyệt và tiến hành{" "}
                  <Text className="font-tbold">hủy lịch hẹn</Text>, đồng thời
                  hoàn trả chi phí cho khách hàng. Ngoài ra, nếu chuyên viên{" "}
                  <Text className="font-tbold">vi phạm quy tắc</Text>, khách
                  hàng có quyền <Text className="font-tbold">gửi báo cáo</Text>{" "}
                  tới hệ thống. Nếu bị báo cáo quá{" "}
                  <Text className="font-tbold">2 lần trong tháng</Text>, tài
                  khoản của chuyên viên sẽ bị{" "}
      ...
      <Modal
        ...
        description="Bạn có chắc chắn muốn tham gia vào hệ thống tư vấn không?"
        confirmText="Đồng ý"
        cancelText="Hủy"
