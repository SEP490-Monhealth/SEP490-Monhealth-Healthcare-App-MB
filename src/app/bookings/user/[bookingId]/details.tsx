...
const quickReview = [
  { value: "Dịch vụ tuyệt vời" },
  { value: "Rất hài lòng" },
  { value: "Tư vấn tốt" },
  { value: "Hỗ trợ nhiệt tình" },
  { value: "Tốt hơn mong đợi" },
  { value: "Tuyệt vời" }
]
                  ...
                  <View className="flex-row flex-wrap gap-2">
                    {quickReview.map((quick) => (
                      <Chip
                        ...
                        borderWidth={1}
                        size="sm"
                        selected={selectedReviews.includes(quick.value)}
                        onPress={() => handleSelectQuick(quick.value)}
                      />
                    ))}
                  </View>
