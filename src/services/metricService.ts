...
export const createMetric = async (
  ...
  try {
    ...
    showDialog(message || "Tạo thông tin sức khỏe thành công")

    console.log(message)
    return message
  } catch (error: any) {
    if (axios.isAxiosError(error)) {
      showDialog("Đã xảy ra lỗi khi tạo thông tin sức khỏe")
...
export const updateMetric = async (
  ...
  try {
    ...
    showDialog(message || "Cập nhật thông tin thành công")

    console.log(message)
    return message
  } catch (error: any) {
    if (axios.isAxiosError(error)) {
      showDialog("Đã xảy ra lỗi khi cập nhật thông tin")
